  ...
  transforms: {
    ...
    SUBPACKAGELIST(content, _options, configuration) {
      ...
      return header + fs
        ...
        .map(([link, packages]) => {
          let entry = `| [${packages.name}](https://github.com/cerner/terra-framework/tree/master/${link}) | [![NPM version](https://badgen.net/npm/v/${packages.name})](https://www.npmjs.org/package/${packages.name}) | ![Stable](https://badgen.net/badge/status/Stable/green) | [![${packages.name}](https://badgen.net/david/dep/cerner/terra-framework/packages/${packages.name})](https://david-dm.org/cerner/terra-framework?path=packages/${packages.name}) |`;
