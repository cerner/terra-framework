...
describe('ApplicationLayout', () => {
  describe('Displays a default application layout', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-application-layout/application-layout');
  ...
  describe('Displays an application layout with top navigation tabs', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-application-layout/application-layout-no-top-nav');
      browser.waitForVisible('#application-layout-test');
    });
  ...
  describe('Displays an application layout with no header content', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-application-layout/application-layout-empty');
      browser.waitForVisible('#application-layout-test');
    });
