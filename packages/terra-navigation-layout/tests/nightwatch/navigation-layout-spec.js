...
module.exports = resizeTo(['tiny', 'small', 'medium', 'large', 'huge'], {
  'Displays a basic NavigationLayout': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/navigation-layout/navigation-layout-basic`);
  ...
  'Displays a complex NavigationLayout': (browser) => {
    browser.url(`${browser.launchUrl}/#/tests/navigation-layout/navigation-layout-complex`);
