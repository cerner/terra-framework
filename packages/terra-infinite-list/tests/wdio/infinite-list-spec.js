...
Terra.describeViewports('InfiniteList', ['small'], () => {
  it('Displays an infinite list with loading indicator', () => {
    browser.url('/raw/tests/cerner-terra-framework-docs/infinite-list/infinite-list-loading');
  ...
  it('Displays an infinite list with updating indicator', () => {
    browser.url('/raw/tests/cerner-terra-framework-docs/infinite-list/infinite-list-updating');
    $('#test-infinite-list').waitForDisplayed();
    Terra.validates.element('with updating indicator', { selector });
  });

  it('Displays an infinite list with selection', () => {
    browser.url('/raw/tests/cerner-terra-framework-docs/infinite-list/infinite-list-selection');
    $('#test-infinite-list').waitForDisplayed();
    $('#root').moveTo(0, 900);
  ...
  it('Displays an infinite list with role as listbox', () => {
    browser.url('/raw/tests/cerner-terra-framework-docs/infinite-list/infinite-list-listbox');
    $('#test-infinite-list').waitForDisplayed();
    $('#root').moveTo(0, 900);
  ...
  it('Displays an infinite list with virtual dom from top', () => {
    browser.url('/raw/tests/cerner-terra-framework-docs/infinite-list/infinite-list-virtual');
    $('#test-infinite-list').waitForDisplayed();
    browser.pause(150);
  ...
  describe('Displays an infinite list same count and different content', () => {
    it('displays before updating child items', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/infinite-list/infinite-list-same-count');
      $('#test-infinite-list').waitForDisplayed();
      browser.pause(150);
