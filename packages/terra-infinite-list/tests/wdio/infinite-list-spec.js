...
describe('InfiniteList', () => {
  describe('Displays an infinite list with loading indicator', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-infinite-list/infinite-list-loading');
  ...
  describe('Displays an infinite list with updating indicator', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-infinite-list/infinite-list-updating');
      browser.waitForVisible('#test-infinite-list');
    });
  ...
  describe('Displays an infinite list with selection', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-infinite-list/infinite-list-selection');
      browser.waitForVisible('#test-infinite-list');
    });
  ...
  describe('Displays an infinite list with virtual dom from top', () => {
    beforeEach(() => {
      browser.url('/#/raw/tests/terra-infinite-list/infinite-list-virtual');
      browser.waitForVisible('#test-infinite-list');
      browser.pause(150);
    });
