...
import AggregatorPropsTable from '../../../../src/Aggregator.jsx?dev-site-props-table';
...
[View component source code](https://github.com/cerner/terra-framework/tree/master/packages/terra-aggregator)
