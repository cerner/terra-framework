...
disclosureManager.disclose({
  ...
  /**
   * Additional custom properties to override disclosed component.
   * For instance to set panelBehavior when using a slidepanel manager use `typeConfig: { panelBehavior: 'squish' }`.
   */
