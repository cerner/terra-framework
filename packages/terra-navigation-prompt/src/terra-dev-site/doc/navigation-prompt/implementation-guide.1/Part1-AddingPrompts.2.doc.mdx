...
import ImplementationGuidePart1 from '../examples/ImplementationGuidePart1?dev-site-example';
...
## Example 
<ImplementationGuidePart1 title='Part 1 - Implementing the NavigationPrompt and NavigationPromptCheckpoint' />
