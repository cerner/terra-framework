...
module.exports = resizeTo(['small', 'large', 'huge'], {
  'Displays a default layout': (browser) => {
    browser.url(`${browser.launchUrl}/#/site/tests/layout/layout-default`);
  ...
  'Displays a layout with no menu': (browser) => {
    browser.url(`${browser.launchUrl}/#/site/tests/layout/layout-no-menu`);
  ...
  'Displays a layout with long menu control text': (browser) => {
    browser.url(`${browser.launchUrl}/#/site/tests/layout/layout-long-text`);
  ...
  'Displays a layout without a header': (browser) => {
    browser.url(`${browser.launchUrl}/#/site/tests/layout/layout-no-header`);
