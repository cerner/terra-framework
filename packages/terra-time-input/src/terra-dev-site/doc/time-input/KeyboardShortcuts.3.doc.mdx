...
|-|-|
| N | Sets the time value to the current time. |
...
### 4.43.0
* Initial release. This adds the key listeners to the hour number input, minute number input, and second number input.
