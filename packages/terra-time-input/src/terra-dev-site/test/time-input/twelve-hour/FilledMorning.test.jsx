...
const TimeInputDefault = () => (
  <>
    ...
    <p>We are essentially working with a dual input for time (an input for hours and an input for minutes) that visually appears as one input. Each input functions independently and combines the ease auto-advance or backspace to quickly key time values. We would appreciate any feedback you can afford to help us provide the right amount of context for assistive technology users or any other disabled user. Specifically, we would like feedback on the time input itself but welcome any constructive criticism or advice to improve the group of controls.</p>
    <h2>Known issues:</h2>
    ...
    <ul>
      Questions for the accessibility community:
