 ...
 */
const removeTransientComponent = (id) => {
 ...
 */
const presentTransientComponent = (component, containerId, locale, customMessages) => {
  /**
    ...
    render((
      <Base locale={locale} customMessages={customMessages}>
        {React.cloneElement(component, {
          transientComponent: {
            containerId,
            remove: () => removeTransientComponent(containerId),
          },
        })}
      </Base>
    ),
...
export default {
  presentTransientComponent,
  removeTransientComponent,
};
