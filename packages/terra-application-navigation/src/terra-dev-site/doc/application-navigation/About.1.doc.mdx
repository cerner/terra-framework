...
This component has been moved to [terra-application](/application/terra-application/components/application-navigation) and should be imported from that package. While this is the final major version of this component we will release, this component will continue to receive minor updates until terra adopts react 17.
...
If the 'id' prop is defined it allows consumers to generate unique ids for all of the sub navigation, extension, and utility items

The ids will follow this format [id]-[item type]-[item key]

For example, if the 'id' prop is 'main-navigation' and has an extension item with the key of 'meds' the generated id for the extension item will be 'main-navigation-ExtensionItem-meds'
