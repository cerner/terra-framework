...
describe('ApplicationTabs', () => {
  describe('Displays a default application tabs', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      testName: 'themed',
      properties: {
        '--terra-application-tabs-tab-width': '9rem',
        '--terra-application-tabs-tab-margin-next-to-icon': '1rem',
        '--terra-application-tabs-menu-arrow-left-margin': '2rem',
        '--terra-application-tabs-tab-background-image': 'linear-gradient(to bottom, red, orange)',
        '--terra-application-tabs-tab-background-position': 'top',
        '--terra-application-tabs-tab-background-size': '0 9px',
        '--terra-application-tabs-tab-divider-before-border-left': '1px solid green',
        '--terra-application-tabs-tab-divider-before-border-right': '1px solid pink',
        '--terra-application-tabs-tab-color': '#000',
        '--terra-application-tabs-tab-font-size': '1rem',
        '--terra-application-tabs-tab-line-height': '1',
        '--terra-application-tabs-tab-hover-background-color': 'rgba(0, 0, 0, 0.15)',
        '--terra-application-tabs-tab-active-background-color': 'pink',
        '--terra-application-tabs-tab-active-background-size': '100% 9px',
        '--terra-application-tabs-tab-active-color': '#000',
        '--terra-application-tabs-tab-hover-background-image': 'linear-gradient(to bottom, orange,red)',
        '--terra-application-tabs-tab-hover-background-size': '100% 9px',
        '--terra-application-tabs-tab-hover-color': 'gray',
      },
    });
  });
