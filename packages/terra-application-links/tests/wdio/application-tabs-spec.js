...
describe('ApplicationTabs', () => {
  describe('Displays a default application tabs', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      testName: 'themed',
      properties: {
        '--terra-application-links-tab-width': '9rem',
        '--terra-application-links-tab-menu-display-width': '9rem',
        '--terra-application-links-tab-margin-next-to-icon': '1rem',
        '--terra-application-links-tabs-menu-arrow-margin-left': '2rem',
        '--terra-application-links-tab-background-image': 'linear-gradient(to bottom, red, orange)',
        '--terra-application-links-tab-background-position': 'top',
        '--terra-application-links-tab-menu-display-tab-inner-background-position': 'top',
        '--terra-application-links-tab-tab-inner-background-size': '0 9px',
        '--terra-application-links-tab-menu-display-tab-inner-background-size': '0 9px',
        '--terra-application-links-tab-divider-before-border-left': '1px solid green',
        '--terra-application-links-tab-menu-display-divider-before-border-left': '1px solid green',
        '--terra-application-links-divider-after-last-tab-divider-before-border-left': '1px solid green',
        '--terra-application-links-tab-divider-before-border-right': '1px solid pink',
        '--terra-application-links-tab-menu-display-divider-before-border-right': '1px solid pink',
        '--terra-application-links-divider-after-last-tab-divider-before-border-right': '1px solid pink',
        '--terra-application-links-tab-color': '#000',
        '--terra-application-links-tab-menu-display-color': '#000',
        '--terra-application-links-tab-font-size': '1rem',
        '--terra-application-links-tab-menu-display-font-size': '1rem',
        '--terra-application-links-tab-line-height': '1',
        '--terra-application-links-tab-menu-display-line-height': '1',
        '--terra-application-links-tab-tab-inner-hover-background-color': 'rgba(0, 0, 0, 0.15)',
        '--terra-application-links-tab-menu-display-tab-inner-hover-background-color': 'rgba(0, 0, 0, 0.15)',
        '--terra-application-links-tab-active-background-color': 'pink',
        '--terra-application-links-tab-active-background-size': '100% 9px',
        '--terra-application-links-tab-active-color': '#000',
        '--terra-application-links-tab-hover-background-image': 'linear-gradient(to bottom, orange,red)',
        '--terra-application-links-tab-hover-background-size': '100% 9px',
        '--terra-application-links-tab-hover-color': 'gray',
        '--terra-application-links-tab-text-transform': 'uppercase',
        '--terra-application-links-tab-menu-display-text-transform': 'uppercase',
      },
    });
  });
