...
var CollapseTab = /*#__PURE__*/function (_Component) {
  (0, _inherits2.default)(CollapseTab, _Component);
  var _super = _createSuper(CollapseTab);
  function CollapseTab(props) {
    var _this;
    (0, _classCallCheck2.default)(this, CollapseTab);
  ...
  (0, _createClass2.default)(CollapseTab, [{
    key: "handleOnBlur",
    ...
    value: function render() {
      ...
      var tabClassNames = (0, _classnames.default)(cx('collapsed-tab', {
      ...
      return /*#__PURE__*/_react.default.createElement("li", (0, _extends2.default)({}, customProps, tabAttr, {
        tabIndex: "0",
        ...
        className: cx('collapsed-tab-icon')
      }, icon), /*#__PURE__*/_react.default.createElement("span", {
...
CollapseTab.contextType = _terraThemeContext.default;
var _default = CollapseTab;
