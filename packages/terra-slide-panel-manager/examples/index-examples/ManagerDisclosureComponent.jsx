...
class ManagerDisclosureComponent extends React.Component {
  constructor(props) {
    super(props);
            ...
            onClick={() => {
              app.disclose({
                ...
                content: {
                  ...
                  component: <ManagerDisclosureComponent name={`Nested ${this.props.name}`} />,
                },
              });
            }}
          />
...
ManagerDisclosureComponent.propTypes = propTypes;
ManagerDisclosureComponent.defaultProps = defaultProps;

export default ManagerDisclosureComponent;
