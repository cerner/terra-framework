...
describe('ColumnHeaderCell', () => {
  it('renders default column header cell', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
    };
  ...
  it('renders column header cell with ascending sort', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
  ...
  it('renders column header cell with descending sort', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
  ...
  it('renders column header cell with error', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
      hasError: true,
  ...
  it('renders column header cell with ascending sort and error', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
      sortIndicator: 'ascending',
  ...
  it('renders column header cell with onColumnSelect callback', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
      sortIndicator: 'ascending',
  ...
  it('renders column header cell with onColumnSelect callback but not selectable', () => {
    const column = {
      id: 'Column-0',
      displayName: ' Vitals',
      sortIndicator: 'ascending',
