...
class DateTimePicker extends React.Component {
  constructor(props) {
    ...
    this.timeZone = props.initialTimeZone;

    this.state = {
      dateTime: DateTimeUtils.createSafeDate(props.value, this.timeZone),
    ...
    this.timeValue = DateTimeUtils.hasTime(this.props.value, this.timeZone) ? DateTimeUtils.getTime(this.props.value, this.props.showSeconds, this.timeZone) : '';
  ...
  componentDidUpdate() {
    ...
    if (this.state.dateTime && DateTimeUtils.isValidTime(this.timeValue, this.props.showSeconds)) {
      const displayedTime = DateTimeUtils.getTime(this.state.dateTime.format(), this.props.showSeconds, this.timeZone);
  ...
  getMetadata(momentDateTime) {
    ...
    if (DateUtil.isValidDate(this.dateValue, this.state.dateFormat)) {
      const enteredDateTime = DateTimeUtils.convertDateTimeStringToMomentObject(this.dateValue, this.timeValue, this.state.dateFormat, this.props.showSeconds, this.timeZone);
    ...
    if (iSOString) {
      timeValue = DateTimeUtils.getTime(iSOString, this.props.showSeconds, this.timeZone);
    }
  ...
  handleDateChange(event, date) {
    ...
    if (isDateValid) {
      const previousDateTime = this.state.dateTime ? this.state.dateTime.clone() : DateTimeUtils.createSafeDate(formattedDate, this.timeZone);
      ...
      if (isTimeValid) {
        ...
        this.timeValue = DateTimeUtils.getTime(updatedDateTime.format(), this.props.showSeconds, this.timeZone);
      }
    }
  ...
  handleTimeChange(event, time) {
    this.timeValue = time;
    const validDate = DateUtil.isValidDate(this.dateValue, this.state.dateFormat) && this.isDateTimeAcceptable(DateTimeUtils.convertDateTimeStringToMomentObject(this.dateValue, this.timeValue, this.state.dateFormat, this.props.showSeconds, this.timeZone));
    ...
    if (validDate && validTime) {
      ...
      if (updatedDateTime) {
        displayedTimeValue = DateTimeUtils.getTime(updatedDateTime.format(), this.props.showSeconds, this.timeZone);
      }
  ...
  isDateTimeAcceptable(newDateTime) {
    ...
    if (DateUtil.isDateOutOfRange(newDateTime, DateTimeUtils.createSafeDate(DateUtil.getMinDate(this.props.minDate), this.timeZone), DateTimeUtils.createSafeDate(DateUtil.getMaxDate(this.props.maxDate), this.timeZone))) {
      isAcceptable = false;
    }
