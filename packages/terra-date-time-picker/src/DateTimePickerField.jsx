...
const propTypes = {
  ...
  */
   ...
   */
  dateLabelAttrs: PropTypes.object,
  /**
   ...
   * The label of the form control children.
   */
  timeLabel: PropTypes.node.isRequired,
  /**
   * Attributes to attach to the label.
   */
  timeLabelAttrs: PropTypes.object,
  /**
...
class DateTimePickerField extends React.Component {
  ...
  render() {
    ...
    const helpLabel = help && (
      <div aria-label={`${intl.formatMessage({ id: 'Terra.datePicker.dateFormatLabel' })} ${help}`}>
        &nbsp;
        {help}
      </div>
    );
...
DateTimePickerField.contextType = ThemeContext;
