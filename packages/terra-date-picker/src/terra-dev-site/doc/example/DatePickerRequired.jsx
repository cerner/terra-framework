...
class DatePickerRequired extends React.Component {
  constructor(props) {
    super(props);
...
DatePickerRequired.propTypes = propTypes;
DatePickerRequired.defualtProps = defaultProps;

export default DatePickerRequired;
