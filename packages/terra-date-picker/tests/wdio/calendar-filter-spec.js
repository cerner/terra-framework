Terra.describeViewports('Calendar Filter', ['tiny'], () => {
  describe('Calendar-Filter-Default', () => {
    it('renders with default calendar-filter', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-default');
  ...
  describe('Calendar-Filter with Default Date Excluded', () => {
    it('renders with default date disabled', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-default-date-excluded');
  ...
  describe('Calendar-Filter with Default Date Out Of Range', () => {
    it('renders with default date disabled', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-default-date-out-of-range');
  ...
  describe('Calendar-Filter with minDate and maxDate', () => {
    it('renders with min and max-date', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-min-max');
  ...
  describe('Calendar-Filter with Exclude Dates', () => {
    it('renders with excluded date', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-exclude-dates');
  ...
  describe('Calendar-Filter with filtered Dates', () => {
    it('renders with filtered date', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-filter-dates');
  ...
  describe('Calendar-Filter with Included Dates', () => {
    it('renders with Included date', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-include-dates');
  ...
  describe('Calendar-Filter with OnChange Callback', () => {
    it('renders selected date on change', () => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-on-change');
  ...
  describe('Controlled Calendar Filter', () => {
    before(() => {
      browser.url('/raw/tests/cerner-terra-framework-docs/date-picker/calendar-filter/calendar-filter-controlled');
    });
