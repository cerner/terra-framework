  ...
  describe('Default', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      properties: {
        ...
        '--terra-brand-footer-horizontal-nav-link-before-padding-bottom': '5px',
        '--terra-brand-footer-horizontal-nav-link-before-padding-top': '5px',
        '--terra-brand-footer-horizontal-nav-link-before-padding-left': '5px',
        '--terra-brand-footer-horizontal-nav-link-before-padding-right': '5px',
