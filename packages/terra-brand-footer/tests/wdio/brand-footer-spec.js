  ...
  describe('Default', () => {
    ...
    Terra.should.themeCombinationOfCustomProperties({
      ...
      properties: {
        ...
        '--terra-brand-footer-horizontal-nav-first-link-before-padding-right': '5px',
        '--terra-brand-footer-horizontal-nav-link-separator-padding-bottom': '5px',
        '--terra-brand-footer-horizontal-nav-link-separator-padding-top': '5px',
        '--terra-brand-footer-horizontal-nav-link-separator-padding-left': '5px',
        '--terra-brand-footer-horizontal-nav-link-separator-padding-right': '5px',
