...
describe('ApplicationHeaderName', () => {
  describe('Displays a default application header name', () => {
    beforeEach(() => browser.url('/#/raw/tests/terra-application-name/application-header-name-default'));
  ...
  describe('Displays a truncated application header name', () => {
    beforeEach(() => browser.url('/#/raw/tests/terra-application-name/application-header-name-truncated'));
