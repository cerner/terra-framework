...
describe('ApplicationMenuName', () => {
  describe('Displays a default application menu name', () => {
    beforeEach(() => browser.url('/#/raw/tests/terra-application-name/application-menu-name-default'));
  ...
  describe('Displays a truncated application menu name', () => {
    beforeEach(() => browser.url('/#/raw/tests/terra-application-name/application-menu-name-truncated'));
