...
import ModalPropsTable from '../../../../src/AbstractModal?dev-site-props-table';
...
[1]: https://github.com/cerner/terra-framework/tree/master/packages/terra-modal-manager/src/terra-dev-site/doc/modal-manager/About.1.doc.mdx
...
[View component source code](https://github.com/cerner/terra-framework/tree/master/packages/terra-abstract-modal)
