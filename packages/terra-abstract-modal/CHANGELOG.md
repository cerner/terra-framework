...
----------
### Changes
* Updated `_ModalContent` to trigger the inhert dom updates when it is mounted and unmouted to remove the updates from the componentDidUpdate hook in the `AbstractModal`
