...
export default function SlidePanelManagerAriaDescribedByWithReplaceExample() {
  return (
    <>
      <p id="allergy-info-1">This section contains a list of patient allergies.</p>
      <p id="allergy-info-2">Selecting an allergy from the list will open an allergy detail panel.</p>
      <SlidePanelManager
        mainAriaLabel="Patient allergies"
        mainAriaDescribedBy="allergy-info-1 allergy-info-2"
