...
const ColumnActionsWithRowSelection = () => {
  ...
  cols.forEach((col, columnIndex) => {
    if (columnIndex < 5) {
      col.action = {
        ...
        onClick: () => alert(`Column action for ${col.displayName} clicked`),
      };
    }
  });
  ...
  return (
    <React.Fragment>
      ...
      <WorklistDataGrid
        id="wdg-with-column-actions-and-row-selection"
        ...
        ariaLabel="Worklist Data Grid with Column Actions and Row Selection"
...
export default ColumnActionsWithRowSelection;
