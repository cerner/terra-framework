...
const FlowsheetWithSectionsAndActions = () => {
  ...
  return (
    <FlowsheetDataGrid
      id="flowsheet-with-sections-and-actions"
...
export default FlowsheetWithSectionsAndActions;
