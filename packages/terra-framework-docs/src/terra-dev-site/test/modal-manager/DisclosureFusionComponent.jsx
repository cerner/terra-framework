  ...
  render() {
    ...
    return (
      <ContentContainer id={identifier} className="nested-component" fill header={<h2 className={cx('header')}>Content Component</h2>}>
        ...
        <button type="button" className="disclose-fusion-small" onClick={this.disclose('fusion-small')}>Disclose Small (Fusion)</button>
        <button type="button" className="disclose-fusion-medium" onClick={this.disclose('fusion-medium')}>Disclose Medium (Fusion)</button>
        <button type="button" className="disclose-fusion-large" onClick={this.disclose('fusion-large')}>Disclose Large (Fusion)</button>
