...
Terra Notification Dialog was updated to use React-Intl `v5` and drops support for React-Intl `v4` and lower.
Projects consuming Terra Notification Dialog version 5 should use React Intl version >= 5.
