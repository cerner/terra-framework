...
* The **onRowSelect** callback prop: When the user selects a row header cell (a cell in the pinned first column), this callback will be called with an object containing the `rowId` and `sectionId` of the selected row.
