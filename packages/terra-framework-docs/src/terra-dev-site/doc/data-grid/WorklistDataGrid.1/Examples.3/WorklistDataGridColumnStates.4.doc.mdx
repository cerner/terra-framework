...
### Description
This example demonstrates a [Worklist DataGrid](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about) that supports column states and selection.
A column can be selected by clicking on the column or pressing the Spacebar on the focused column. Only columns that are selectable can be selected. A column is selectable by default.
