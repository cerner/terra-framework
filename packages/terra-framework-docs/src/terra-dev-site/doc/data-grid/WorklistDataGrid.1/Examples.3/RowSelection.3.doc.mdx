...
### Properties required
 by utilizing the following [Worklist DataGrid properties](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#properties):
* hasSelectableRows
* onRowSelect
* onRowSelectAll
* onClearSelectedRows
...
[All Grid Keyboard Interactions](http://localhost:8080/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#keyboard-interactions)
