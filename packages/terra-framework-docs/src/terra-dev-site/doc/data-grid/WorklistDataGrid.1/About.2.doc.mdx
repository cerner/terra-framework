...
|-|-|
|[DefaultWorklistDataGrid](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/examples/default-worklist-data-grid)|An example of the Worklist Data Grid with basic keyboard interactions.|
...
|Control + End <br/> or <br/> Ctrl + Command + Right Arrow (Mac) | Moves focus to the last cell in the last row.|
...
* [aria-label](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-label)
  * **Worklist Data Grid**: When [_ariaLabel_](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#worklist-datagrid-props-table) prop is specified, the screen reader will use the _aria-label_ as the [accessible name](https://w3c.github.io/accname/#dfn-accessible-name) for the grid.
...
### Column
Column specifies the data to render a cell in the header row of the Worklist Data Grid.
