...
import DefaultWorklistDataGrid from './Examples.3/DefaultWorklistDataGrid?dev-site-example';
...
## Overview
  ...
  * [Navigation](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/examples/default-worklist-data-grid)
  * [Masked Cells](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/examples/default-worklist-data-grid)
...
Refer to the [examples](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#examples) section for detailed demonstration of the features supported by the WorklistDataGrid.
...
|-|-|
|[DefaultWorklistDataGrid](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/examples/default-worklist-data-grid)|An example of the Worklist DataGrid with basic keyboard interactions.|
...
List of keyboard interactions supported by Worklist DataGrid is similar to the [keyboard interactions for data grids](https://www.w3.org/WAI/ARIA/apg/patterns/grid/) as outlined by the ARIA Authoring Practices Guide (APG).
...
|Control + End <br/> or <br/> Ctrl + Command + Right Arrow | Moves focus to the last cell in the last row.|
...
* [aria-label](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-label)
  * **Worklist DataGrid**: When [_ariaLabel_](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#worklist-datagrid-props-table) prop is specified, the screen reader will use the _aria-label_ as the [accessible name](https://w3c.github.io/accname/#dfn-accessible-name) for the grid.
  * **Row**: When [_ariaLabel_](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#row) prop is specified, the screen reader will use the _aria-label_ as the [accessible name](https://w3c.github.io/accname/#dfn-accessible-name) to announce interactions with the row.
* [aria-labelledby](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Attributes/aria-labelledby)
  * **Worklist DataGrid**: When [_ariaLabelledBy_](/components/cerner-terra-framework-docs/data-grid/worklist-data-grid/about#worklist-datagrid-props-table) prop is specified, the screen reader will use the _aria-labelledby_ element to determine the [accessible name](https://w3c.github.io/accname/#dfn-accessible-name) for the grid.
...
### Worklist DataGrid Props Table
<WorklistDataGridPropsTable />

### Column
Column specifies the data to render a cell in the header row of the Worklist DataGrid.
...
### Row
Row defines the cells rendered within the row.
