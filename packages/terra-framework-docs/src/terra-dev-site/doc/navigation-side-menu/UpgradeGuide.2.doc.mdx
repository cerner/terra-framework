...
Terra Navigation Side Menu was updated to use React-Intl `v5` and drops support for React-Intl `v4` and lower.
Projects consuming Terra Navigation Side Menu version 3 should use React Intl version >= 5.
