...
import VisualFocusIndicator from './example/VisualFocusIndicator?dev-site-example';
import BasicConsumerSrcDoc from './example/BasicConsumerSrcDoc?dev-site-example';
...
<VisualFocusIndicator title='Focus Indicator on the frame' />
<BasicConsumerSrcDoc title='Example `srcdoc` inline html content' />
