...
The following FolderTree.Item props are required for row selection:
* **[isSelected](../about#foldertreeitem-props-table)**: Specifies whether or not the FolderTree.Item is currently selected. 
