...
* **isSelected**: Identifies whether or not the FolderTreeItem is currently selected. 
* **onClick**: This callback is called when selecting a row via either of the following methods:
  * Mouse click:
