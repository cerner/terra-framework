...
## Overview
Folder Tree is an accessible [tree view](https://www.w3.org/WAI/ARIA/apg/patterns/treeview/) component that allows the user to display data in a hierarchical tree-like structure of nested rows.
