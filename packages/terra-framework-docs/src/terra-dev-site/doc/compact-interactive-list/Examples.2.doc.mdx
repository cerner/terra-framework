...
import FocusableCellContent from './Examples/FocusableCellContent?dev-site-examples';
import CellSelection from './Examples/CellSelection?.dev-site-examples';
...
<FocusableCellContent />

## Cell selection

A cell is selected by clicking on the cell or pressing the Spacebar on the focused cell. 
A cell is selectable unless it has an interactable element within itself (in that case the interactive element default controls apply).
