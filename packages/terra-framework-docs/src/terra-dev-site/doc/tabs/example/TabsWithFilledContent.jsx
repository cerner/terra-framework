  ...
  const tab1 = (
    ...
    >
      <TabContent label="Large Content">
        <p>Users need to know what is going on, and get appropriate feedback during interaction. For example, users need confirmation messages when actions are completed, such as when forms are submitted. Also, error messages must provide clear directions rather than confuse users.
          ...
          Content is more usable for people who are new to the particular website or application.</p>
        <p>  Content is more usable for people who are not confident using computers and the web.
          ...
          People with learning disabilities who cannot understand complex sentence structures and vocabulary.</p>
        <p>  People with cognitive disabilities who have difficulty focusing on long passages of dense text.
          ...
          Content is easier to skim, and get an overview of the information.</p>
        <p>  Avoid overly complex words, jargon, and acronyms, or provide explanations when they need to be used. Provide structure using headings, lists, and spacing. Provide illustrations that clarify the content, when helpful. Provide clear layout and design with consistent orientation and navigation cues.
          ...
          Content is more adaptable to personal preferences and comfort.</p>
        <p>  Content is more adaptable when translated, since words and sentences are different lengths in different languages.
          ...
          Content is more usable on touch screens, especially on smaller mobile devices.</p>
        <p>  Content is more usable for people who are not experienced with the mouse or touch-pad on the computer they are using.
