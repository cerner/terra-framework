  ...
  return (
    ...
    >
      <WorkspaceItem
        ...
        render={() => (
          <div role="none" className={cx('panel-content')}>
            <div role="none">
              <div role="tabpanel" tabIndex="0" id="test-id-tab-1-panel" aria-labelledby="test-id-tab-1" data-application-overflow-container>
                <div>
                  <p>Tab 1 Content</p>
                  <p>
      ...
      <WorkspaceItem
        ...
        label="Tab 2"
        customDisplay={(
          <div id="customDisplayContent" className={cx('custom-display')}>
        ...
        render={() => (
          <div role="none" className={cx('panel-content')}>
            <div role="none">
              <div role="tabpanel" tabIndex="0" id="test-id-tab-2-panel" aria-labelledby="test-id-tab-2" data-application-overflow-container>
                <div>
                  <p>Tab 2 Content</p>
                  <p>
      ...
      <WorkspaceItem
        ...
        render={() => (
          <div role="none" className={cx('panel-content')}>
            <div role="none">
              <div role="tabpanel" tabIndex="0" id="test-id-tab-3-panel" aria-labelledby="test-id-tab-3" data-application-overflow-container>
                <div>
                  <p>Tab 3 Content</p>
                  <p>
      ...
      <WorkspaceItem
        ...
        render={() => (
          <div role="none" className={cx('panel-content')}>
            <div role="none">
              <div role="tabpanel" tabIndex="0" id="test-id-tab-4-panel" aria-labelledby="test-id-tab-4" data-application-overflow-container>
                <div>
                  <p>Tab 4 Content</p>
                  <p>
      ...
      <WorkspaceItem
        ...
        render={() => (
          <div role="none" className={cx('panel-content')}>
            <div role="none">
              <div role="tabpanel" tabIndex="0" id="test-id-tab-6-panel" aria-labelledby="test-id-tab-6" data-application-overflow-container>
                <div>
                  <p>Tab 6 Content</p>
                  <p>
                    Maecenas aliquam congue augue sed tristique. Vivamus eu consectetur sapien, in eleifend magna. Etiam laoreet ligula eu fermentum tincidunt. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed magna nunc, tempor vitae sagittis eu, vulputate ac lorem. Etiam massa ante, aliquam ac consequat et, efficitur dictum turpis. Integer malesuada purus in lobortis ornare. In hac habitasse platea dictumst. Aliquam finibus ipsum quis nibh volutpat, a posuere mi vestibulum. Cras tincidunt odio et aliquet mollis. Ut ac felis neque. Integer nulla elit, mattis eleifend dui pretium, euismod tristique nulla. Curabitur vulputate viverra odio, vitae blandit est dapibus eu.
