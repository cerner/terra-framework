...
import ImplementationGuidePart2 from '../examples/ImplementationGuidePart2?dev-site-example';
...
## Examples 
<ImplementationGuidePart2 title='Part 2 - Implementing a Custom Prompt Handler' />
