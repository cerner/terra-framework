...
<div style={{ background: "#def3dcab", padding: "15px", 'border-radius': "5px"}}>
    <h4 id="pill-accesibility-heading" style={{ 'border-bottom': "2px solid #33e148", background: "#f7f7f70f", 'margin-top': "5px"}}> IMPORTANT </h4>
