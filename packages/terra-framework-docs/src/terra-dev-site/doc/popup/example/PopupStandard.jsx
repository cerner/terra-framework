  ...
  return (
    <React.Fragment>
      <div>
        ...
        Using inert makes the content outside the popup inaccessible to screen readers and keyboard interactions while the modal is active, ensuring keyboard focus is trapped within the popup for better accessibility.
      </div>
