...
Terra Time Input was updated to use React-Intl `v5` and drops support for React-Intl `v4` and lower.
Projects consuming Terra Time Input version 5 should use React Intl version >= 5.
