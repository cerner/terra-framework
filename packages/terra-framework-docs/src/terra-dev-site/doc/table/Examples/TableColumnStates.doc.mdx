...
The below example also demonstrates how properties such as _hasError_ and _sortIndicator_ can be provided by the consumer to control if column header displays an error indicator or shows a sort indicator icon respectively.
