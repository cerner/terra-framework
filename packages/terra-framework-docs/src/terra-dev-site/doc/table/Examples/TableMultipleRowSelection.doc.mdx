...
|Outcome|Action|
|---|---|
|Select a Row|When multiple row selection is enabled, select the row, or press **TAB** until the row is active and then press the **SPACEBAR** to select the checkbox.|
|Clear a Row|Select the row, or press **TAB** until the row is active and then press the **SPACEBAR** to clear the checkbox.|
