...
Due to poor support in Apple VoiceOver for spanned table headings, the Table component is not currently recommended for applications used on Apple devices.
</Notice>
