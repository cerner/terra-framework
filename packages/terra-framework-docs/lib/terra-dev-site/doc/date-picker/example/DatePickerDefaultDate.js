...
var DatePickerExampleDefaultDate = function DatePickerExampleDefaultDate() {
  var todaysDate = (0, _momentTimezone.default)().format('YYYY-MM-DD');
  var _useState = (0, _react.useState)(todaysDate),
...
var _default = DatePickerExampleDefaultDate;
