...
var DatePickerExampleControlled = function DatePickerExampleControlled() {
  var _useState = (0, _react.useState)((0, _momentTimezone.default)().format('YYYY-MM-DD')),
...
var _default = DatePickerExampleControlled;
