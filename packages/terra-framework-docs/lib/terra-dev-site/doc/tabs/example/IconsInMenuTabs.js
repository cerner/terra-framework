...
var IconsOnlyAndInMenuTabs = function IconsOnlyAndInMenuTabs(props) {
  ...
  _react.default.createElement(_terraTabs.default.Pane, {
    label: "Briefcase",
  ...
  var envelopeTab = /*#__PURE__*/_react.default.createElement(_terraTabs.default.Pane, {
    label: "Envelope",
  ...
  var printerTab = /*#__PURE__*/_react.default.createElement(_terraTabs.default.Pane, {
    label: "Printer",
  ...
  }, searchTab, briefcaseTab, bookmarkTab, calendarTab, envelopeTab, printerTab));
};
IconsOnlyAndInMenuTabs.propTypes = propTypes;
var _default = IconsOnlyAndInMenuTabs;
