...
**Note:** by choosing to create a custom Notification Dialog, you are responsible for providing an icon that is themed correctly in the terra-default-theme, orion-fusion-theme and in the clinical-lowlight-theme. See Terra's [Theme Strategy Guide](https://engineering.cerner.com/terra-ui/guides/terra-application/theme-strategy) for more information.
