...
var DatePickerOnChangeRaw = function DatePickerOnChangeRaw() {
  ...
  var handleDateChangeRaw = function handleDateChangeRaw(event, dateValue, options) {
    setDate(dateValue);
    setISO(options.iSO);
...
var _default = DatePickerOnChangeRaw;
