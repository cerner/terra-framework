...
Terra.describeViewports('ModalManager', ['tiny', 'large'], () => {
  before(() => {
    browser.url('/#/raw/tests/terra-framework-docs/modal-manager/modal-manager-default');
    browser.refresh();
  });
...
Terra.describeViewports('ModalManager - Behaviors', ['large'], () => {
  ...
  describe('Component Integration', () => {
    before(() => browser.url('/#/raw/tests/terra-framework-docs/modal-manager/modal-manager-integration'));
...
Terra.describeViewports('ModalManager - Managed Header', ['large'], () => {
  describe('Disclosure - Header Close', () => {
    before(() => {
      browser.url('/#/raw/tests/terra-framework-docs/modal-manager/modal-manager-with-header-adapter');
      browser.refresh();
    });
...
Terra.describeViewports('ModalManager - Disclosure Accessory', ['large'], () => {
  describe('Disclosure Accessory', () => {
    before(() => {
      browser.url('/#/raw/tests/terra-framework-docs/modal-manager/modal-manager-with-disclosure-accessory');
      browser.refresh();
    });
  ...
  describe('Disclosure Container', () => {
    before(() => {
      browser.url('/#/raw/tests/terra-framework-docs/modal-manager/with-disclosure-container');
      browser.refresh();
    });
