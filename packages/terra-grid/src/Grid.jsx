...
class Grid extends React.Component {
  ...
  handleKeyDown(event) {
    ...
    switch (key) {
      case GridUtil.KEY_CODES.UP_ARROW:
        nextRow -= 1;
        break;
      case GridUtil.KEY_CODES.DOWN_ARROW:
        nextRow += 1;
        break;
      case GridUtil.KEY_CODES.LEFT_ARROW:
        nextCol -= 1;
        break;
      case GridUtil.KEY_CODES.RIGHT_ARROW:
        nextCol += 1;
        break;
      case GridUtil.KEY_CODES.HOME:
        nextCol = 0;
        if (event.ctrlKey) {
          nextRow = this.getNumberOfHeaderRows();
        }
        break;
      case GridUtil.KEY_CODES.END:
