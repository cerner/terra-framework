...
function rimrafDir(dirPath) {
  ...
  return (0, import_path_exists.default)(dirPath).then((exists) => {
    ...
    const slashed = import_path12.default.normalize(`${dirPath}/`);
...
var import_npmlog32, import_path12, import_path_exists, childProcess9, RIMRAF_CLI;
    ...
    var CleanCommand = class extends Command {
      ...
      initialize() {
        ...
        return chain.then(() => {
          ...
          this.logger.info(
            "clean",
            this.directoriesToDelete.map((dir) => import_path13.default.relative(this.project.rootPath, dir)).join("\n")
          );
