...
var _excluded = ["text", "title", "onClick", "isOpen", "isTransparent", "level"];
...
var SectionHeader = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(SectionHeader, [{
    ...
    value: function render() {
      ...
      var Element = "h".concat(level || 2);
      var headerText = text || title;
...
SectionHeader.contextType = _terraThemeContext.default;
