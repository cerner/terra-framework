...
var _excluded = ["allowClear", "children", "defaultValue", "disabled", "error", "help", "hideRequired", "isIncomplete", "isInline", "isInvalid", "isLabelHidden", "label", "labelAttrs", "maxHeight", "maxWidth", "onChange", "placeholder", "required", "selectAttrs", "selectId", "showOptional", "value"];
...
var SingleSelectField = function SingleSelectField(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_terraFormField.default, _extends({}, customProps, {
    ...
    htmlFor: selectId,
    maxWidth: maxWidth
  }), /*#__PURE__*/_react.default.createElement(_SingleSelect.default, _extends({}, selectAttrs, {
    ariaLabel: label,
