  ...
  _createClass(Menu, [{
    ...
    value: function handleKeyDown(event) {
      ...
      if (keyCode === KeyCode.KEY_UP) {
        ...
        this.setState(function (prevState) {
          return {
            active: _MenuUtil.default.findWithStartString(prevState.children, _this3.searchString) || active
          };
        });
      }
    }
    ...
    value: function updateNoResultsScreenReader() {
      ...
      this.liveRegionTimeOut = setTimeout(function () {
        var hasNoResults = _this4.state.hasNoResults;
        var _this4$props = _this4.props,
          intl = _this4$props.intl,
          visuallyHiddenComponent = _this4$props.visuallyHiddenComponent;
    ...
    value: function updateCurrentActiveScreenReader() {
      var _this$props3 = this.props,
        ...
        clearOptionDisplay = _this$props3.clearOptionDisplay,
      ...
      return _react.default.Children.map(object, function (option) {
        if (option.type.isOption) {
          return /*#__PURE__*/_react.default.cloneElement(option, _objectSpread({
            ...
            isActive: option.props.value === _this5.state.active,
            isCheckable: false,
            isSelected: _MenuUtil.default.isSelected(_this5.props.value, option.props.value),
            variant: 'default',
            onMouseDown: function onMouseDown() {
              _this5.downOption = option;
            },
            onMouseUp: function onMouseUp(event) {
              return _this5.handleOptionClick(event, option);
            },
            onMouseEnter: function onMouseEnter(event) {
              return _this5.handleMouseEnter(event, option);
            }
          }, option.props.value === _this5.state.active && {
            'data-select-active': true
          }));
        }
        if (option.type.isOptGroup) {
          return /*#__PURE__*/_react.default.cloneElement(option, {}, _this5.clone(option.props.children));
        }
        return option;
      });
    }
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (_MenuUtil.default.shouldShowClearOption({
        ...
        children.unshift( /*#__PURE__*/_react.default.createElement(_ClearOption.default, {
