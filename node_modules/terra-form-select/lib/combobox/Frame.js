...
var _excluded = ["ariaLabel", "clearOptionDisplay", "children", "disabled", "display", "dropdownAttrs", "inputId", "intl", "isIncomplete", "isTouchAccessible", "isInvalid", "maxHeight", "noResultContent", "onDeselect", "onSearch", "onSelect", "optionFilter", "placeholder", "required", "totalOptions", "value"];
...
var Frame = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var selectClasses = (0, _classnames.default)(cx('select', 'combobox', {
