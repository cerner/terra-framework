...
var _excluded = ["ariaLabel", "children", "disabled", "display", "dropdownAttrs", "inputId", "intl", "isIncomplete", "isTouchAccessible", "isInvalid", "maxHeight", "maxSelectionCount", "noResultContent", "onDeselect", "onSearch", "onSelect", "optionFilter", "placeholder", "required", "totalOptions", "value"];
...
var Frame = /*#__PURE__*/function (_React$Component) {
  ...
  function Frame(props) {
    ...
    _this.handleToggleButtonClick = _this.handleToggleButtonClick.bind(_assertThisInitialized(_this));
  ...
  _createClass(Frame, [{
    ...
    value: function handleToggleButtonClick() {
      if (this.state.isOpen) {
        this.closeDropdown();
        if (this.input) {
          this.input.focus();
    ...
    key: "getDisplay",
    value: function getDisplay(displayId, ariaDescribedBy, id) {
      ...
      return /*#__PURE__*/_react.default.createElement("ul", {
        "data-terra-form-select-input": true,
        className: cx('content')
      }, display && display.length > 0 ? /*#__PURE__*/_react.default.createElement("li", null, /*#__PURE__*/_react.default.createElement("ul", {
        id: displayId,
        className: cx('display-content')
      }, display, /*#__PURE__*/_react.default.createElement("li", {
        className: cx('visually-hidden-component')
      }, /*#__PURE__*/_react.default.createElement(_reactIntl.FormattedMessage, {
        id: "Terra.form.select.selected"
      })))) : null, /*#__PURE__*/_react.default.createElement("li", {
    ...
    value: function positionDropdown() {
      ...
      var _this$props3 = this.props,
        dropdownAttrs = _this$props3.dropdownAttrs,
        maxHeight = _this$props3.maxHeight,
        isTouchAccessible = _this$props3.isTouchAccessible;
    ...
    value: function render() {
      ...
      var _this$props6 = this.props,
        ...
        maxSelectionCount = _this$props6.maxSelectionCount,
        ...
        customProps = _objectWithoutProperties(_this$props6, _excluded);
      var theme = this.context;
      var selectClasses = (0, _classnames.default)(cx(['select', 'multiple', {
      ...
      }, this.getDisplay(displayId, ariaDescribedBy, this.menuId)), this.renderToggleButton(), /*#__PURE__*/_react.default.createElement("span", {
        "aria-atomic": "true",
        "aria-live": "assertive",
