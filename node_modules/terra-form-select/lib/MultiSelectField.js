...
var _excluded = ["children", "defaultValue", "disabled", "error", "help", "hideRequired", "intl", "isIncomplete", "isInline", "isInvalid", "isLabelHidden", "isTouchAccessible", "label", "labelAttrs", "maxHeight", "maxSelectionCount", "maxWidth", "onChange", "placeholder", "required", "selectAttrs", "selectId", "showOptional", "value"];
...
var MultiSelectField = function MultiSelectField(_ref) {
  ...
  if (maxSelectionCount !== undefined && maxSelectionCount >= 2) {
    ...
    if (help) {
      helpText = /*#__PURE__*/_react.default.createElement("span", null, limitSelectionText, ' ', help);
    } else {
  ...
  return /*#__PURE__*/_react.default.createElement(_terraFormField.default, _extends({}, customProps, {
    ...
    htmlFor: selectId,
    maxWidth: maxWidth
  }), /*#__PURE__*/_react.default.createElement(_MultiSelect.default, _extends({}, selectAttrs, {
    ariaLabel: label,
