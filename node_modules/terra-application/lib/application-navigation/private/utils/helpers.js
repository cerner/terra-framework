...
exports.userActionItemId = userActionItemId;
exports.utilityItemId = utilityItemId;
var _react = require("react");
var _keycodeJs = require("keycode-js");
var _sanitizeId = _interopRequireDefault(require("../../../utils/sanitize-id"));
/**
...
function itemId(appNavId, itemType, itemKey) {
  return (0, _sanitizeId.default)("".concat(appNavId, "-").concat(itemType, "-").concat(itemKey));
}
