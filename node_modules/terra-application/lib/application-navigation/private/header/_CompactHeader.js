...
var propTypes = {
   ...
   */
  skipToWorkspaceAction: _propTypes.default.func
};
var defaultProps = {
  extensionItems: [],
...
function buildUtilityItem(text, key, onSelect, isUtilityOpen, id) {
  return /*#__PURE__*/_react.default.createElement("li", {
    id: id && (0, _helpers.utilityItemId)(id, "hidden-".concat(key)),
    key: key,
...
var CompactHeader = function CompactHeader(_ref) {
  var isDrawerMenuOpen = _ref.isDrawerMenuOpen,
    ...
    skipToWorkspaceAction = _ref.skipToWorkspaceAction;
  ...
  function renderMenuButton() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      "aria-label": intl.formatMessage({
        id: 'terraApplication.navigation.header.menuButtonTitle'
      }),
  ...
  function buildNavigationItems() {
    ...
    return /*#__PURE__*/_react.default.createElement("nav", {
      ...
      return /*#__PURE__*/_react.default.createElement("li", {
        ...
        id: id && (0, _helpers.navigationItemId)(id, "hidden-".concat(item.key)),
        role: "link",
        className: cx('hidden-item'),
  ...
  function buildUtilityItems() {
    ...
    return /*#__PURE__*/_react.default.createElement("ul", {
      role: "listbox",
      "aria-label": intl.formatMessage({
        id: 'terraApplication.navigation.drawerMenu.utilities'
      }),
  ...
  function renderSkipToWorkspace() {
    ...
    return /*#__PURE__*/_react.default.createElement("button", {
      type: "button",
      role: "link",
      onClick: skipToWorkspaceAction,
      className: cx('skip-content-button')
    }, intl.formatMessage({
      id: 'terraApplication.workspace.skipToLabel'
    }));
  }
  return /*#__PURE__*/_react.default.createElement("header", {
    role: "banner",
    className: cx('compact-header', theme.className)
    ...
    id: 'terraApplication.navigation.header.skipToContentTitle'
  })), renderSkipToWorkspace(), renderMenuButton(), /*#__PURE__*/_react.default.createElement("div", {
