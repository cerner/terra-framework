...
exports.getNxWrapperContents = exports.updateGitIgnore = exports.writeMinimalNxJson = exports.generateEncapsulatedNxSetup = exports.nxWrapperPath = void 0;
...
exports.generateEncapsulatedNxSetup = generateEncapsulatedNxSetup;
...
function getNxWrapperContents() {
    ...
    return (0, fs_1.readFileSync)(path.join(__dirname, 'nxw.js'), 'utf-8').replace(/(\/\/# .*)|(\/\/\w*)$/gm, '');
}
