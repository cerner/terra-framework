...
var _RadioFieldModule = _interopRequireDefault(require("./RadioField.module.scss"));
...
var cx = _bind.default.bind(_RadioFieldModule.default);
var propTypes = {
  /**
...
var RadioField = function RadioField(props) {
  ...
  var radioFieldClasses = (0, _classnames.default)(cx('radio-field', {
    'is-inline': isInline
  }, theme.className), customProps.className);
  var legendClassNames = cx(['legend', legendAttrs.className]);
  var legendAriaDescriptionId = "terra-radio-field-description-".concat((0, _lodash.default)());
  var helpAriaDescriptionId = help ? "terra-radio-field-description-help-".concat((0, _lodash.default)()) : '';
  var errorAriaDescriptionId = error ? "terra-radio-field-description-error-".concat((0, _lodash.default)()) : '';
...
var _default = (0, _reactIntl.injectIntl)(RadioField);
